...
void ggml_compute_forward_sparse_soft_max(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_compress_k(const struct ggml_compute_params * params, struct ggml_tensor * dst);
