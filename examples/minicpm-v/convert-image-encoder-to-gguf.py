...
def should_skip_tensor(name: str, has_text: bool, has_vision: bool, has_llava: bool) -> bool:
    ...
    if has_llava and name in ["visual_projection.weight", "vision_model.post_layernorm.weight", "vision_model.post_layernorm.bias", "vpm.norm.weight", "vpm.norm.bias"]:
        return True
...
if has_vision_encoder:
    ...
    fout.add_float32(k(KEY_ATTENTION_LAYERNORM_EPS, VISION), v_hparams["rms_norm_eps"])
    ...
    if "image_grid_pinpoints" in v_hparams:
        print("image_grid_pinpoints in config")
        # flatten it
        image_grid_pinpoints = []
    ...
    if "scale_resolution" in v_hparams:
        fout.add_uint32("clip.vision.scale_resolution", v_hparams["scale_resolution"])
